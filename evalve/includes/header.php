                ...
                <div class="container">
                    <div class="header-top-grids">
                        <!-- <div class="agileits-logo">
                            <h1><a href="index.php">Evalve </a></h1>
                        </div> -->
                        <div class="top-nav">
                            <nav class="navbar navbar-default">
                                ...
                                <div class="agileits-logo">
                                    <h1><a href="index.php" style="font-size:xx-large">Evalve </a></h1>
                                </div>
                                ...
                                <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                                    <nav>
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li><a href="eventes.php">Event</a></li>
                        ...
                        <li class=""><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Login<span class="caret"></span></a>
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="hvr-bounce-to-bottom" href="signup.php">Register</a></li>   
                                                     <li><a class="hvr-bounce-to-bottom" href="admin/login.php">Admin</a></li>
                                                    <!-- <li><a class="hvr-bounce-to-bottom" href="logout.php">Logout</a></li>         -->
                                                </ul>
                                            </li>
                            <!-- <ul style="color: white;text-decoration:none;">
                                <li style="color: white;"><a href="">Login</a></li>
