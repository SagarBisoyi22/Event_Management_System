...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        <title>Evalve - Manage Event Type</title>
...
{               ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                         ...
                                         <td class="d-none d-sm-table-cell"><a href="manage-event-type.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-primary">Delete</a></td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
