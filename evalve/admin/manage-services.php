...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        <title>Evalve - Manage Services</title>
...
{               ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                         ...
                                         <td class="d-none d-sm-table-cell"><a href="manage-services.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger">Delete</a></td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
