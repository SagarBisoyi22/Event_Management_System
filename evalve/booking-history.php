...
<html lang="en">
<head>
<title>Online Event Booking System|| Booking History </title>
...
<?php } ?> 
                                         <td class="d-none d-sm-table-cell"><a href="view-booking-detail.php?editid=<?php echo htmlentities ($row->ID);?>&&bookingid=<?php echo htmlentities ($row->BookingID);?>" class="btn btn-primary">View</a></td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
